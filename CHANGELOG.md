...
- Gateway/Aillium: add an authenticated in-process browser capture endpoint for read-only live observer frames, reusing configured browser profiles without exposing a separate browser HTTP port.
