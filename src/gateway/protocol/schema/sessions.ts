...
export const SessionsPatchParamsSchema = Type.Object(
  {
    ...
    authProfileId: Type.Optional(Type.Union([NonEmptyString, Type.Null()])),
    authProfileSource: Type.Optional(
      Type.Union([Type.Literal("auto"), Type.Literal("user"), Type.Null()]),
    ),
